...
class Movie(models.Model):
    ...
    open_date = models.CharField(max_length=300)
    genre1 = models.CharField(max_length=300)
    genre2 = models.CharField(max_length=300,blank=True)
    genre3 = models.CharField(max_length=300,blank=True)
    watch_grade = models.CharField(max_length=300)
    poster_url = models.CharField(max_length=300)
    user_rating = models.FloatField()
    naver_link = models.CharField(max_length=300)
